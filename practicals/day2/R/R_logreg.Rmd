...
```{r}
con <- url("https://www.gerkovink.com/rabobank/practicals/Day%202/R/Titanic.csv")
...
pred %>% 
  ...
  geom_line(aes(colour = Pclass), lwd = 1) + ylab("Probability of Survival") + xlab("Age of passenger") + facet_wrap(vars(Sex)) + scale_fill_discrete(name = "Pclass", labels = c("1st class", "2nd class", "3rd class")) + labs(colour = "Passenger class", fill = "Passenger class") + scale_colour_discrete(name = "Pclass", labels = c("1st class", "2nd class", "3rd class"))
